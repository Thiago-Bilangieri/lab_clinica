...
import 'package:lab_clinica_self_service/src/repositories/documents/documents_repository_impl.dart';

class DocumentsScanConfirmRoute extends FlutterGetItModulePageRouter {
  const DocumentsScanConfirmRoute({super.key});
